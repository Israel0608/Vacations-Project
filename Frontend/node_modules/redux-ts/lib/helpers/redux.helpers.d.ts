import { ActionCreatorDefinition, DispatchToProps } from '../';
export declare const createAction: <TPayload = any, TMeta = any>(type: string) => ActionCreatorDefinition<TPayload, TMeta>;
/**
...
* @param {*} map
*/
export declare const mapDispatchToProps: DispatchToProps;
